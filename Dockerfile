...
#RUN pip3 install 'pyspark==2.4.2'
#RUN pip3 install 'numba==0.41.0'
#RUN pip3 install 'biopython==1.72'
# Install mmtfPySpark
#RUN pip3 install git+https://github.com/sbl-sdsc/mmtf-pyspark.git
